...
describe('Prerender', function(){
  ...
  it('should call next() if the url is not part of the whitelist', function(){
    var req = { url: '/profile/blah', headers: { 'user-agent': bot } },
      res = { send: sinon.stub() },
      next = sinon.stub();
  ...
  it('should return a prerendered response if the url is not part of the blacklist', function(){
    var req = { url: '/profile/blah', headers: { 'user-agent': bot } },
      res = { send: sinon.stub() },
      next = sinon.stub();
